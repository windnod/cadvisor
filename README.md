...
![test status](https://github.com/windnod/cadvisor/workflows/Test/badge.svg)
...
```
VERSION=v0.36.0 # use the latest release version from https://github.com/windnod/cadvisor/releases
sudo docker run \
  --volume=/:/rootfs:ro \
